...
<body>
 ...
 <!-- Register -->
 <div class="container">
            <form class="form-horizontal" role="form" method="post" action="panel1.jsp">
                <h2>Register Course</h2>
                <div class="form-group">
                    <label for="courseid" class="col-sm-4 control-label">Course Id*</label>
                    <div class="col-sm-9">
                        <input type="number" name="cid" placeholder="Course Id" class="form-control" value="<% out.print(request.getParameter("courseId")); %>">
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="container">
                 <input formaction = "updateData.jsp" type="submit" class="btn btn-info" value="Register">
               </div>
            </form> <!-- /form -->
        </div> <!-- ./container -->
